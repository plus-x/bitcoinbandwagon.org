...
if (!defined('COOL_PROCESS_VERSION_CURRENT'))
    define('COOL_PROCESS_VERSION_CURRENT', '1.1.2');
     define('COOL_PROCESS_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
     define('COOL_PROCESS_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
 	 defined( 'FA_DIR' ) or define( 'FA_DIR', plugin_dir_path( __FILE__ ).'/icons-selector/' );
	defined( 'FA_URL' ) or define( 'FA_URL', plugin_dir_url( __FILE__ ).'/icons-selector/'  );
